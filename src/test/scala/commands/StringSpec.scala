...
class StringOperationsSpec extends Spec 
  ...
  describe("get") {
    it("should retrieve key/value pairs for existing keys") {
      r send set("anshin-1", "debasish")
      r send get("anshin-1") should equal(Some("debasish"))
    }
  ...
  describe("getset") {
    it("should set new values and return old values") {
      r send set("anshin-1", "debasish")
      r send get("anshin-1") should equal(Some("debasish"))
      r send getset("anshin-1", "maulindu") should equal(Some("debasish"))
      r send get("anshin-1") should equal(Some("maulindu"))
    }
  }
  ...
  describe("get with spaces in keys") {
    it("should retrieve key/value pairs for existing keys") {
      ...
      r send get("anshin software") should equal(Some("debasish ghosh"))
  ...
  describe("get with newline values") {
    it("should retrieve key/value pairs for existing keys") {
      r send set("anshin-x", "debasish\nghosh\nfather")
      r send get("anshin-x") should equal(Some("debasish\nghosh\nfather"))
    }
  }
}
